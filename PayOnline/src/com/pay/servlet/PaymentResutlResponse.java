...
public class PaymentResutlResponse extends HttpServlet {  
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)  
            throws ServletException, IOException {  
    	 String p1_MerId = "10001126856"; // 商家编号
         ...
         boolean result = PaymentUtil.checkHmac(p1_MerId, r0_Cmd, r1_Code, r2_TrxId, r3_Amt,
         ...
         if(result){
             if("1".equals(r1_Code)){//付款成功
            	 ...
            	 System.out.println("PaymentResutlResponse.doPost()");
